...
# Message.
tellraw @a ["",{"text":" $$$","bold":true,"color":"yellow"},{"text":" > ","color":"dark_gray"},{"selector":"@s","color":"gold"},{"text":" has sold ","color":"gold"},{"score":{"name":"@s","objective":"sell_count"},"color":"gold"},{"text":" item(s) for ","color":"gold"},{"score":{"name":"@s","objective":"sell_remaining"},"color":"gold"},{"text":" coins!","color":"gold"}]
