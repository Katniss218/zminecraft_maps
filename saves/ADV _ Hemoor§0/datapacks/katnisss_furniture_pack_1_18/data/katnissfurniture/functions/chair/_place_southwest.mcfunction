...
execute align xyz positioned ~0.5 ~ ~0.5 unless entity @e[type=armor_stand,tag=katnissfurniture,distance=..0.5] run summon minecraft:armor_stand ~ ~ ~ {Rotation:[45F,0F],Invisible:1b,Invulnerable:1b,NoGravity:1b,DisabledSlots:4144959,Tags:["katnissfurniture","katnissfurniture.chair"],ArmorItems:[{},{},{},{id:"minecraft:diamond_hoe",Count:1b,tag:{CustomModelData:218000}}]}
